...
VASTParser = _dereq_('./parser.nhaccuatui');

VASTUtil = _dereq_('./util.nhaccuatui');
...
},{"./parser.nhaccuatui":8,"./util.nhaccuatui":14}],4:[function(_dereq_,module,exports){
// Generated by CoffeeScript 1.7.1
var VASTCompanionAd;
...
// Generated by CoffeeScript 1.7.1
module.exports = {
  client: _dereq_('./client.nhaccuatui'),
  tracker: _dereq_('./tracker.nhaccuatui'),
  parser: _dereq_('./parser.nhaccuatui'),
  util: _dereq_('./util.nhaccuatui')
};

},{"./client.nhaccuatui":3,"./parser.nhaccuatui":8,"./tracker.nhaccuatui":10,"./util.nhaccuatui":14}],7:[function(_dereq_,module,exports){
// Generated by CoffeeScript 1.7.1
var VASTMediaFile;
...
URLHandler = _dereq_('./urlhandler.nhaccuatui');

VASTResponse = _dereq_('./response.nhaccuatui');

VASTAd = _dereq_('./ad.nhaccuatui');

VASTUtil = _dereq_('./util.nhaccuatui');

VASTCreativeLinear = _dereq_('./creative.nhaccuatui').VASTCreativeLinear;

VASTCreativeCompanion = _dereq_('./creative.nhaccuatui').VASTCreativeCompanion;

VASTMediaFile = _dereq_('./mediafile.nhaccuatui');

VASTCompanionAd = _dereq_('./companionad.nhaccuatui');
...
},{"./ad.nhaccuatui":2,"./companionad.nhaccuatui":4,"./creative.nhaccuatui":5,"./mediafile.nhaccuatui":7,"./response.nhaccuatui":9,"./urlhandler.nhaccuatui":11,"./util.nhaccuatui":14,"events":1}],9:[function(_dereq_,module,exports){
// Generated by CoffeeScript 1.7.1
var VASTResponse;
...
VASTClient = _dereq_('./client.nhaccuatui');
...
},{"./client.nhaccuatui":3,"./creative.nhaccuatui":5,"./util.nhaccuatui":14,"events":1}],11:[function(_dereq_,module,exports){
// Generated by CoffeeScript 1.7.1
var URLHandler, flash, xhr;

xhr = _dereq_('./urlhandlers/xmlhttprequest.nhaccuatui');

flash = _dereq_('./urlhandlers/flash.nhaccuatui');
...
URLHandler = (function() {
  ...
  URLHandler.get = function(url, options, cb) {
    ...
    if (options.urlhandler && options.urlhandler.supported()) {
      ...
      return _dereq_('./urlhandlers/' + 'node.nhaccuatui').get(url, options, cb);
...
},{"./urlhandlers/flash.nhaccuatui":12,"./urlhandlers/xmlhttprequest.nhaccuatui":13}],12:[function(_dereq_,module,exports){
// Generated by CoffeeScript 1.7.1
var FlashURLHandler;
